...
if ($_POST["kayitet"]) {
  ...
  $tarih                            = date("Ymd-His");
  $kategori_kayitTarihi             = date("Y-m-d H:i:s");
  $kategori_durum=1;
  //echo '<script type="text/javascript">alert("'.$tarih.$kategori_kayitTarihi.'");</script>';
  $ks=kategorisorgula($db,$kategori_adi);
  if ($ks==0) {
        ...
        if ($image->processed) {
          $query=$db->prepare("INSERT INTO kategoriler SET
            ...
            if ($insert) {
              ...
              <h1>
              <i class="fa fa-archive"></i> Kategori Ekle
              </h1>
              <div class="callout callout-success">
              <h4>Kategori Başarıyla Eklendi!</h4>
              <p>Teşekkürler.</p>
              </div>
              </section>
              ';
    ...
    <div class="callout callout-danger">
    <h4>Aynı İsimde Kategori Mevcut.</h4>
    </div>
    </section>
    ';
  }
        ...
        <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input class="form-control" id="inputEmail3" placeholder="Kategori Adı" type="text" name="kategori_adi" required>
              </div>
            </div>
            <div class="form-group">
              <label  class="col-sm-2 control-label">Kategori Description</label>
              <div class="col-sm-10">
                <input class="form-control" id="inputEmail3" placeholder="Kategori Kısa Açıklaması" type="text" name="kategori_description" required>
              </div>
            </div>
            <div class="form-group">
              <label  class="col-sm-2 control-label">Kategori Keyword</label>
              <div class="col-sm-10">
                <input class="form-control" id="inputEmail3" placeholder="Kategori Keyword" type="text" name="kategori_keyword" required>
              </div>
            </div>
            <div class="form-group">
              <label  class="col-sm-2 control-label">Kategori İçerik</label>
              <div class="col-sm-10">
                <textarea class="ckeditor" cols="80" id="editor1" name="kategori_icerik" rows="10"></textarea>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input id="exampleInputFile" type="file" name="kategori_icon" required>
              </div>
            </div>
          </div><!-- /.box-body -->
